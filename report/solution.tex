...
\begin{algorithmic}[1]
\Procedure{breakDown}{$faceFaceInput, mappings, boundingBoxes, displacement $}
...
\Procedure{batchingBreakDown}{$faceFaceInput, mappings, boundingBoxes, displacement $}
    ...
    \For{$i \gets 0, splitfactor$}
        ...
        \State breakDown($faceFaceInput, mappings, boundingBoxes, displacement $) \Comment{parallel version}
    \EndFor
\EndProcedure
\end{algorithmic}
\end{algorithm}
